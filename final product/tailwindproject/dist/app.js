...
function Makecards(arr) {
  ...
  var url = "https://www.youtube.com/"; // Replace with your desired URL
  cardContainer.setAttribute("href", url);
...
const toggleButton = document.querySelector(".navIcon");
const under_mobile =document.querySelector(".under-mobile");
console.log(under_mobile);


toggleButton.addEventListener('click', () => {
  if (mobilemenu.classList.contains("click")) {

    mobilemenu.classList.remove("click")
    mobilemenu.style.transform = 'translateY(-10px)';
    mobilemenu.style.opacity = '0';

    under_mobile.style.transform=""
